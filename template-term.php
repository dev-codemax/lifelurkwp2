...
<?php  get_header('privacyTerm'); ?> 

<main class="about">

<aside class="about__left">
  ...
  <nav>
    ...
    <ul>
      ...
      <li><a href="#3">License</a></li>
      <li><a href="#4">Hyperlinking to our Content</a></li>
      <li><a href="#5">iFrames</a></li>
      <li><a href="#6">Your Privacy</a></li>
      <li><a href="#7">Reservation of Rights</a></li>
      <li><a href="#8">Disclaimer</a></li>
...
<div class="about__right">
  ...
  <div class="about__right__illustration">
    <img
      src="https://www.thebalancesmb.com/thmb/DIyXVD5zcL11HEZvZox-FLw3-To=/896x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/AboutUsPageArt_Artboard5-4352d765b3b14ee1be5c78acd0eaf355.jpg"
      alt="">
  </div>
  <div class="about__right__describtion">

    <p>Welcome to Lifelurk!</p>

    <p>These terms and conditions outline the rules and regulations for the use of Lifelurk's Website, located at
      https://www.lifelurk.com.</p>

    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Lifelurk if
    ...
    <h3 id="#2"><strong>Cookies</strong></h3>

    <p>We employ the use of cookies. By accessing Lifelurk, you agreed to use cookies in agreement with the
      Lifelurk's Privacy Policy. </p>
    ...
    <h3 id="#3"><strong>License</strong></h3>

    <p>Unless otherwise stated, Lifelurk and/or its licensors own the intellectual property rights for all material
      on Lifelurk. All intellectual property rights are reserved. You may access this from Lifelurk for your own
      personal use subjected to restrictions set in these terms and conditions.</p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from Lifelurk</li>
      <li>Sell, rent or sub-license material from Lifelurk</li>
      <li>Reproduce, duplicate or copy material from Lifelurk</li>
      <li>Redistribute content from Lifelurk</li>
    </ul>

    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
      areas of the website. Lifelurk does not filter, edit, publish or review Comments prior to their presence on
      the website. Comments do not reflect the views and opinions of Lifelurk,its agents and/or affiliates. Comments
      reflect the views and opinions of the person who post their views and opinions. To the extent permitted by
      applicable laws, Lifelurk shall not be liable for the Comments or for any liability, damages or expenses
      caused and/or suffered as a result of any use of and/or posting of and/or appearance of the Comments on this
      website.</p>

    <p>Lifelurk reserves the right to monitor all Comments and to remove any Comments which can be considered
    ...
    <p>You hereby grant Lifelurk a non-exclusive license to use, reproduce, edit and authorize others to use,
      reproduce and edit any of your Comments in any and all forms, formats or media.</p>

    <h3 id="#4"><strong>Hyperlinking to our Content</strong></h3>
    ...
    <ul>
      ...
      <li>[dot.com](http://dot.com/) community sites;</li>
    ...
    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
      ...
      Lifelurk; and (d) the link is in the context of general resource information.</p>
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
      you must inform us by sending an e-mail to Lifelurk. Please include your name, your organization name, contact
    ...
    <p>No use of Lifelurk's logo or other artwork will be allowed for linking absent a trademark license agreement.
    </p>

    <h3 id="#5"><strong>iFrames</strong></h3>
    ...
    <h3 id="#6"><strong>Your Privacy</strong></h3>

    <p>Please read Privacy Policy</p>

    <h3 id="#7"><strong>Reservation of Rights</strong></h3>
    ...
    <h3 id="#8"><strong>Disclaimer</strong></h3>
